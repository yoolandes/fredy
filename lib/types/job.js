 ...
 * @property {number | null} [intervalMinutes] Job execution interval in minutes (null = use global interval).
 * @property {number} [jitterPercent] Maximum random delay as percentage of interval (0-50, default: 20). Adds randomness to execution time to avoid detection patterns.
 */
